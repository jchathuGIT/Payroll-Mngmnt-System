 ...
 <title>Add</title>
  ...
  <li><a href="logout">Logout</a></li>
        ...
        <table style="margin-left:5px;align-content:center;width:100%;margin-top: 30px;border-spacing: 0.9em;font-family: tahoma">
            ...
            <tr><td>Date Of Birth<br></td><td><input type="date" name="dob"></td>
            <td>Phone No</td><td><input type="text" name="phoneno"></td>
            <td>Email Id</td><td><input type="email" name="email"></td>
            <td>Date Of Joining<br></td><td><input type="date" name="doj"></td></tr>
            ...
            <td></td><td></td>
            <td></td><td></td></tr>
        <tr><td>Basic Salary</td><td><input type="text" name="bs"></td></tr>
