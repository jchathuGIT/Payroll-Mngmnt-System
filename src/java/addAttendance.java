    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(session.getAttribute("username")!=null)           
            {
                ...
                String workedHours = request.getParameter("totalhours");
                ...
                ps.setInt(3,Integer.parseInt(workedHours));
                
                int i;
                i=ps.executeUpdate();
                
                if(i!=0)
                    response.sendRedirect("welcomehr.jsp?id= "+ empID +" Employee Attendance Details Successfully added !!");
                else
